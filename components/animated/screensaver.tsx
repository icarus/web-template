...
const Screensaver: React.FC<ScreensaverProps> = ({
  ...
  const containerDimensions = useDimensions(containerRef as React.RefObject<HTMLElement>)
  const elementDimensions = useDimensions(elementRef as React.RefObject<HTMLElement>)
