...
export const Content = () => {
  return (
    <>
      <div className="text-white text-center z-20 h-full absolute top-0 p-8 w-full items-center justify-center flex flex-col gap-8">
      ...
      <div className="z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 absolute w-96 md:w-1/4 aspect-square bg-black/60 rounded-full blur-[128px]" />
    </>
  );
};
