...
export function ModelViewer({
  ...
  return (
    <div ref={containerRef} className="scale-150 relative w-full h-svh overflow-hidden flex items-center justify-center">
      ...
      >
        {pixelColors.map((color, index) => (
          <div
            key={index}
            className="size-0.5 transform-gpu transition-colors duration-500 ease-linear"
            style={{
